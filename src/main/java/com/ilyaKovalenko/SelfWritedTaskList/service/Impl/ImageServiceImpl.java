...
import com.ilyaKovalenko.SelfWritedTaskList.domain.Exception.ImageUploadException;
...
public class ImageServiceImpl implements ImageService {
    ...
    public String upload(TaskImage image) {
        ...
        try {
            ...
            throw new ImageUploadException("Image upload failed on bucket create");
        }

        MultipartFile file = image.getFile();

        if (file.isEmpty() || file.getOriginalFilename() == null) {
            throw new ImageUploadException("Image upload failed on validating file");
        }
        ...
        try {
            ...
            throw new ImageUploadException("Image upload input stream");
        }
